...
#End If
		...
		Protected Sub Session_Start(ByVal sender As Object, ByVal e As EventArgs)
			WebApplication.SetInstance(Session, New FilterReportSolutionAspNetApplication())
#If EASYTEST Then
			If ConfigurationManager.ConnectionStrings("EasyTestConnectionString") IsNot Nothing Then
				WebApplication.Instance.ConnectionString = ConfigurationManager.ConnectionStrings("EasyTestConnectionString").ConnectionString
			End If
#End If
			WebApplication.Instance.ConnectionString = DevExpress.Xpo.DB.MSSqlCEConnectionProvider.GetConnectionString("data.db")
