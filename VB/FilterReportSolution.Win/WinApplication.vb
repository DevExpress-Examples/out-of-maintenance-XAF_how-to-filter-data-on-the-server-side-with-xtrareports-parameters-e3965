...
Namespace FilterReportSolution.Win
    Partial Public Class FilterReportSolutionWindowsFormsApplication
        ...
        Private Sub FilterReportSolutionWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
            e.Updater.Update()
            e.Handled = True
#Else
